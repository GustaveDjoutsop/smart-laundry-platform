...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleMachineNotFound(MachineNotFoundException ex) {
        return buildResponse(HttpStatus.NOT_FOUND, "MACHINE_NOT_FOUND", ex.getMessage());
    }

    @ExceptionHandler(MachineNotAvailableException.class)
    public ResponseEntity<Map<String, Object>> handleMachineNotAvailable(MachineNotAvailableException ex) {
